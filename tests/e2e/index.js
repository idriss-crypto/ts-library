...
describe('translating address', () => {
    it('Basic request', async () => {
        ...
        //assert.equal(resultPhone["Metamask ETH"], "0x11E9F9344A9720d2B2B5F0753225bb805161139B")
        //assert.equal(resultPhone["Coinbase BTC"], "bc1qsvz5jumwew8haj4czxpzxujqz8z6xq4nxxh7vh")
    ...
    it('Parametrized request 1', async () => {
        ...
        //const resultPhone = await obj.resolve("+16506655942", {network: "evm", coin: "ETH"})
        //assert.equal(resultPhone["Metamask ETH"], "0x11E9F9344A9720d2B2B5F0753225bb805161139B")
        //assert(Object.keys(resultPhone).every(x => x.includes('ETH')))
